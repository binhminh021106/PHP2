...
<div class="container-fluid px-4 py-4">
        ...
        <div class="d-flex gap-2 align-items-center">
            ...
            <form action="" method="GET" class="d-flex gap-2">
                <div class="input-group shadow-sm">
                    <input type="text" name="search" class="form-control rounded-0 border-dark" placeholder="Tìm tên sản phẩm..." value="{{ $search ?? '' }}">
                    <button class="btn btn-dark rounded-0 px-3" type="submit" title="Tìm kiếm">
                        <i class="fa-solid fa-magnifying-glass"></i>
                    </button>
                </div>
                @if(!empty($search))
                    <a href="/product/index" class="btn btn-outline-dark rounded-0 d-flex align-items-center" title="Xóa bộ lọc">
                        <i class="fa-solid fa-rotate-left"></i>
                    </a>
                @endif
            </form>

            <a href="/product/create" class="btn btn-dark shadow-sm px-4 rounded-0 d-flex align-items-center" style="text-transform: uppercase; font-size: 0.85rem; letter-spacing: 1px; height: 38px;">
    ...
    <div class="mb-3 text-muted small" style="letter-spacing: 0.5px;">
        <span>Tìm thấy <b class="text-dark">{{ $total_records ?? 0 }}</b> sản phẩm @if(!empty($search)) với từ khóa "<b class="text-dark">{{ $search }}</b>" @endif</span>
    </div>
