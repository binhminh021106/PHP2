                ...
                <div class="card border-0 shadow-lg rounded-3">
                    ...
                    <div class="card-header bg-primary text-white py-3 rounded-top-3">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="/category/index" class="btn btn-outline-light btn-sm border-0 bg-white bg-opacity-25">
                        ...
                        <form method="POST" action="/category/store">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group input-group-lg">
                                    <span class="input-group-text bg-light text-primary"><i class="fa-solid fa-tag"></i></span>
                                    <input type="text" class="form-control bg-light" id="name" name="name" required placeholder="Ví dụ: Laptop, Điện thoại..." style="font-size: 0.95rem;">
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control bg-light" id="description" name="description" rows="5" placeholder="Nhập mô tả chi tiết cho danh mục..."></textarea>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text bg-light text-primary"><i class="fa-solid fa-icons"></i></span>
                                    <input type="text" class="form-control bg-light" id="icon" name="icon" placeholder="Ví dụ: fa-solid fa-laptop">
